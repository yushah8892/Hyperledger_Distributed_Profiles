...
class EntityController {
    ...
    static async getNetwork() {
        try {
            ...
            const walletPath = path.join(SETTING.APPL_ROOT_PATH, '/identity/boa');
            ...
            console.log(await gateway.connect(ccpPath, { wallet, identity: 'user2@boa.ifmprofile-network.com', discovery: { enabled: true, asLocalhost: true } }));
