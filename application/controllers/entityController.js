...
class EntityController {
    ...
    static async getNetwork() {
        try {
            ...
            const walletPath = path.join(SETTING.APPL_ROOT_PATH, '/identity/usb');
            ...
            await gateway.connect(ccpPath, { wallet, identity: 'user1@usb.ifmprofile-network.com', discovery: { enabled: true, asLocalhost: true } });
